...
export const SEED: EcoNode[] = [
  ...
  mk('AI & Machine Learning Dept','dept','BSTM Tech Solutions','green','https://t.me/Todd366Bot'),
  ...
  mk('Data Science & Analytics Dept','dept','GIN Analytics Pty Ltd'),
  ...
  mk('Cab/Taxi Platform Dept','dept','CabLink Pty Ltd','green','https://todd366.github.io/CabLink-pwa/'),
  ...
  mk('Nutrition & Health Products Dept','dept','NutriHub Pty Ltd','yellow'),
  ...
  mk('CabLink PWA','dept','Cab/Taxi Platform Dept','green','https://todd366.github.io/CabLink-pwa/','Vue UI · THB rewards · offline bookings'),
  ...Array.from({ length: 63 }, (_, i) => {
    ...
    return mk(`Room ${n}${tag}`, 'room', 'BSTM Holdings', n>=47&&n<=55?'yellow':'green')
  }),
]
